#解析coco2017数据集，将对应的*.json文件，解析到yolo可用的*.txt 格式
...
train_label_subsets = "F:/COCO17/COCO/labels/train2017"
val_label_subsets = "F:/COCO17/COCO/labels/val2017"
dst_label_dir = "F:/COCO17/COCO/labels"
...
coco_data_dir = "{}/COCO17/COCO".format(HOMEDIR)
...
out_anno_dir = "{}/labels".format(coco_data_dir)
